...
public class GamePiece {
	...
	public void up() {yLoc -= 100; row -= 1; if (row < 0) {yLoc = 0; row = 0;}}
	
	public void down() {yLoc += 100; row += 1; if (row > 4) {yLoc = 400; row = 4;}}
	
	public void left() {xLoc -= 100; col -= 1; if (col < 0) {col = 0; xLoc = 0;}}
	
	public void right() {xLoc += 100; col += 1; if (col > 9) {col = 9; xLoc = 900;}}
